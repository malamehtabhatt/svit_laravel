...
For this, we have to put main code in file in which you want to extend layout.
give main code title as section.-->
@extends ('layout');
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<ul class="posts">
								...
								<li class="post">
									<h3 class="entry-title"><a href="#">{{$event->event_date}}</a></h3>
									<span class="date"><i class="icon-calendar"></i> {{$event->title}}</span>
									<span class="location"><i class="icon-map-marker"></i>{{$event->description}}</span>
								</li>
								@endforeach
							</ul>
							<p class="text-center">
